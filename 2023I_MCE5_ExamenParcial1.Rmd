...
Hipotesis nula (Ho): no tiene un efecto en la diversidad de especies en etapas juveniles ni en la reducción de las disparidades de rendimiento entre vecinos de diferentes especies en etapas maduras.

Hipotesis alternativa (Ha): tiene un efecto positivo en la diversidad de especies en etapas juveniles, evitando la extinción de especies localmente raras, y reduce las disparidades de rendimiento entre vecinos de diferentes especies en etapas maduras.
